"""Keyword-based classification of responses into strategy labels."""
...
class KeywordAnalyzer:
    ...
    def _classify_strategy(self, features: Dict[str, int]) -> str:
        # Priority rule: refusal beats balanced, balanced beats hedged, and so on.
    ...
    def _per_100_words(self, count: int, word_count: int) -> float:
        # Normalise so longer responses do not look more hedged just because they are longer.
        if word_count == 0:
            return 0.0
